       ...
       <x-header>
           ...
           <main
               ...
               <div class="w-full pt-4 sm:px-5" style="max-width: 26rem;">

                   <div class="card mt-2 bg-red rounded-lg">
                       ...
                       <div class="pop_bot bg-dark-light pa">
                           ...
                           class="btn w-full space-x-3 border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80"
                             >
                               <img class="h-5.5 w-5.5" src="{{ asset('images/app/facebook.svg') }}" alt="logo">
                   ...
                   <div class="mt-8 flex justify-center text-xs text-slate-400 dark:text-navy-300">
                       ...
                       <a href="{{ url('page/contact') }}">Support center</a>
                   </div>
               </div>
           </main>
       </x-header>
