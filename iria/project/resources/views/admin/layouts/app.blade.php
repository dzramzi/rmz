            ...
            x-transition:enter="ease-out" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="ease-in" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" style="">
                ...
                <div class="flex space-x-5 px-5">
                  <div class="avatar -mt-5 h-20 w-20">
                    <img class="rounded-full border-2 border-white dark:border-navy-700" src="{{$admin_data->profile}}" alt="avatar">
                  ...
                  <div class="mt-2 w-full" style="margin-left:10px;">
                    ...
                    <a class="tag mt-1 bg-error/10 text-error hover:bg-error/20 focus:bg-error/20 active:bg-error/25">
                    Administration</a>
                    </div>
                </div>
                ...
                <ul class="flex flex-1 flex-col px-4 font-medium">
                  <li>
                    ...
                    <li x-data="accordionItem('menu-item-1')">
                      ...
                      <li>
                        <a href="{{ route('admin.missions')}}" class="flex items-center gap-2 group flex space-x-2 rounded-lg px-4 py-2.5 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 py-2 text-xs+ tracking-wide text-slate-500 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50">
                    ...
                    <li x-data="accordionItem('menu-item-3')">
                        <a :class="expanded &amp;&amp; 'text-slate-800 font-semibold dark:text-navy-50'" @click="expanded = !expanded" class="flex items-center justify-between group flex space-x-2 rounded-lg px-4 py-2.5 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 py-2 text-xs+ tracking-wide text-slate-500 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50" href="javascript:void(0);">
                        <div>
                      ...
                      <ul x-collapse="" x-show="expanded" style="display: none; height: 0px; overflow: hidden;" hidden="">
                          <li>
                          <a href="{{route('admin.settings')}}" class="flex items-center justify-between p-2 text-xs+ tracking-wide text-slate-500 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50">
                            <div class="flex items-center space-x-2">
                        ...
                        <li>
                          <a href="{{ route('admin.pages')}}" class="flex items-center justify-between p-2 text-xs+ tracking-wide text-slate-500 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50">
                            <div class="flex items-center space-x-2">
                              <div class="h-1.5 w-1.5 rounded-full border border-current opacity-40"></div>
                              <span>Pages</span>
                            </div>
                         ...
                         <li>
                          <a href="{{ route('admin.postbacks') }}" class="flex items-center justify-between p-2 text-xs+ tracking-wide text-slate-500 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50">
                            <div class="flex items-center space-x-2">
                              <div class="h-1.5 w-1.5 rounded-full border border-current opacity-40"></div>
                              <span>Postbacks</span>
                            </div>
                          ...
                          <li>
                          <a href="{{route('fileviews')}}" class="flex items-center justify-between p-2 text-xs+ tracking-wide text-slate-500 outline-none transition-[color,padding-left] duration-300 ease-in-out hover:pl-4 hover:text-slate-800 dark:text-navy-200 dark:hover:text-navy-50">
                            <div class="flex items-center space-x-2">
                              <div class="h-1.5 w-1.5 rounded-full border border-current opacity-40"></div>
                              <span>Resources</span>
                            </div>
                ...
                <div class="p-5">
                  ...
                  <form method="POST" action="{{ route('admin.logout') }}" x-data>
                    @csrf
                      <button type="submit" class="btn mt-2 w-full space-x-2 bg-error/10 font-medium text-error hover:bg-error/20 focus:bg-error/20 active:bg-error/25">
