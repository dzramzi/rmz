...
<html lang="en">
  ...
  <body x-data class="is-header-blur" x-bind="$store.global.documentBody">
    <!-- App preloader-->
    <!-- App preloader -->
<div class="app-preloader fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-800 to-fuchsia-700">
  <div class="relative w-24 h-24">
    <div class="absolute inset-0 rounded-full border-4 border-white/30 animate-ping"></div>
    <div class="absolute inset-0 rounded-full border-4 border-white/60 animate-pulse"></div>
    <div class="absolute inset-0 rounded-full border-t-4 border-white animate-spin"></div>
  </div>
</div>
    ...
    <div class="flex justify-center mt-10">
      ...
      <div class="mt-8 flex justify-center text-xs text-slate-400 dark:text-navy-300">
            ...
            <a class="text-error" href="https://wa.me/916375825529">By CSM Devs</a>
          </div>
